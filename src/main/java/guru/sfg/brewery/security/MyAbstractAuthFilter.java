...
@Slf4j
public abstract class MyAbstractAuthFilter extends AbstractAuthenticationProcessingFilter {
    public MyAbstractAuthFilter(RequestMatcher requiresAuthenticationRequestMatcher) {
